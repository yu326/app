function taskCanvas(){
    ...
    this.initElement = function(taskele){
        ...
        */
        ...
        spthtml += '<td><input id="tp_activatetime" name="activatetime" class="Wdate" type="text" readonly="readonly" style="width:150px;" onclick="WdatePicker({minDate:\'%y-%M-%d\',dateFmt:\'yyyy-MM-dd HH:mm:ss\'})" /></td>';
        spthtml += '<td class="tdtip"></td>';
        spthtml += '</tr>';
        spthtml += '<tr>';
        ...
        //spthtml += '<option value="-1">solr库</option>';
        ...
        */
        ...
        if(taskele){
            ...
            //console.log(taskPro.specifiedTypeForChild );
    ...
    this.getTaskParam = function(taskid){
        ...
        taskp.taskPro.activatetime = $("#tp_activatetime").val() ? $("#tp_activatetime").val() : "";
    ...
    this.completeCanvas = function(){
        ...
        */
        ...
        //query.specifiedTypeForChild = taskall['root'].taskPro.specifiedTypeForChild;
        //query.specifiedMacForChild = taskall['root'].taskPro.specifiedMacForChild;


        if(taskall['root'].taskPro.activatetime ){
           query.activatetime = taskall['root'].taskPro.activatetime;
        } else {
        	query.activatetime = 0;
        }
       ...
       // query.activatetime = taskall['root'].taskPro.activatetime;
        query.conflictdelay = taskall['root'].taskPro.conflictdelay;
        //console.log( typeof taskall['root'].taskPro.specifiedMacForChild );
        //console.log( taskall['root'].taskPro.specifiedMacForChild );
        ...
        query.remarks = taskall['root'].taskPro.remarks;
        query.taskparams = JSON.stringify(taskall);
        addTask($.param(query), function(r){
            if(r.result){
    ...
    */
    this.show = function(taskparams){
        ...
        if(taskparams !== undefined){
            var taskcount = 0;
            //if( taskparams.taskpro ) {
            //    delete taskparams.taskpro;
            //}
