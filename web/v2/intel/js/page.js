...
Page.prototype.showUpdate_6=function(){
	$("#common-text").hide();
	$("#update-text-6").show();
	$("#five-text").hide();
	$("#update-text-7").hide();
...
Page1.prototype.handleLineData = function(data) {
	...
	if(datalist.length > 0) {
		this.avgValue = totalValue/datalist.length;
	}
};
...
Page1.prototype.createLine = function() {
	var leftYA = -(this.element.find(".line").width() - 50);
	var leftXA = (this.element.find(".line").width() - 130);
...
Page7.prototype.handleTagData = function(data) {
	var array = data.datalist;
	if(!data || !array) {
		return;
	}
...
Page7.prototype.requestMediaPie=function(){
...
Page7.prototype.createPie_1= function() {
	var option = {
		color : [ '#c9ebff', '#85cdfd', '#50affd',
				'#268ffb' ],	
		title : {
...
Page7.prototype.requestChannelPie=function(){
...
Page7.prototype.createPie_2 = function() {
	var option = {
		color : [ '#c9ebff', '#85cdfd', '#50affd',
				'#268ffb'],
		title : {
...
function Page8(token) {
	Page.call(this, token, 8);
	this.element = $("#page-8");
}

Page8.prototype = $.extend({}, Page.prototype);

Page8.prototype.build = function() {
	var html = [];
...
PageManager.prototype.init = function() {
	...
	this.page8 = new Page8();
	this.page9 = new Page9();
...
PageManager.prototype.render = function() {
	...
	this.page8.setToken(this.token);
	this.page9.setToken(this.token);
